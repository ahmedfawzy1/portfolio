  ...
  return (
    ...
    >
      <section
       ...
       relative sm:h-[20rem] rounded-lg hover:bg-gray-200 transition sm:group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20"
      >
        <div
        ...
        <Image
         ...
         group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-3 group-even:group-hover:rotate-2
          group-even:right-[inital] group-even:-left-40 hidden sm:block"
        />
      </section>
    </motion.div>
  );
